                    ...
                    <div class="row" >
                      <div class="col-sm-12 col-md-6">
                        <div class="dataTables_filter text-left" id="dataTable_month"><label>
                          ...
                          <a v-if="!isSelectMonth" v-on:click="createDayTicket" class="btn btn-success btn-circle btn-sm"
                             style="margin-left: 2%">
                            <i class="fas fa-check"></i>
                          </a></label>
                        </div>
                      ...
                      <div class="col-sm-12">
                        <table class="table table-bordered" id="dataTable">
                          ...
                          <tr>
                            ...
                            <td v-else>{{ticketData.ticket._id}}</td>
                            <td>{{ticketData.ticket.vehicle_type}}</td>
                            <td>{{ticketData.ticket.license_plate}}</td>
