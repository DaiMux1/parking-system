<template>
  <div class="container-fluid">
    ...
    <p class="mb-4">
      Bao gồm các thông tin về các xe hiện tại đang có trong bãi
    </p>
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">
          Dữ liệu về các xe trong bãi xe
        </h6>
      </div>
      <div class="card-body">
    ...
    tickets: function () {
      return this.currentTickets.filter((ticket) =>
        ticket.license_plate
          .toLowerCase()
          .includes(this.licensePlate.toLowerCase())
      );
    },
  },
};
