  ...
  <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Dữ liệu về số lượng vé bán được</h6>
      </div>
      <div class="card-body">
            ...
            <div class="row" style="margin-bottom: 1%;">
              <div class="col-sm-12 col-md-6">
                ...
                <div class="dataTables_filter text-left" id="dataTable_month"><label>
                  ...
                  <input v-if="isSelectDate" v-model="date"
                         type="date"
                         class="form-control form-control-sm"
                  >
                  <a v-if="isSelectDate" v-on:click="getStatisticByDay" class="btn btn-success btn-circle btn-sm" style="margin-left: 2%">
                  ...
                  <input v-if="!isSelectDate" v-model="date"
                         ...
                         class="form-control form-control-sm"
                  >
                  <a v-if="!isSelectDate" v-on:click="getStatisticByMonth" class="btn btn-success btn-circle btn-sm" style="margin-left: 2%">
                    <i class="fas fa-check"></i>
                  </a>
                </label>
                </div>
...
<!--                  </tfoot>-->
                  ...
                  <tr>
                    ...
                    <td>{{statistic.day_ticket + statistic.month_ticket}}</td>
                  </tr>
                  </tbody>
                </table>
              </div>
      ...
      try {
        ...
        if (res.data) {
          ...
          if (this.$route.name === "VehicleStatistics") {
            alert("Số lượng xe được gửi trong ngày " + this.date + " sẽ được hiển thị ở bảng dưới !!!");
          }
        }
      } catch (err) {
        alert(err)
